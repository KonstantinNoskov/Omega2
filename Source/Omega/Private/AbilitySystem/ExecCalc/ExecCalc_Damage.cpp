...
struct OmegaDamageStatics
{
	...
	OmegaDamageStatics()
	{
		DEFINE_ATTRIBUTE_CAPTUREDEF(UOmegaAttributeSet, MagicResistance, Target, false)
	}
};
...
void UExecCalc_Damage::Execute_Implementation(const FGameplayEffectCustomExecutionParameters& ExecutionParams, FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	ExecutionParams.AttemptCalculateCapturedAttributeMagnitude(DamageStatics().MagicResistanceDef, EvaluateParams, TargetMagicBlockChance);
